...
class StudyPlanner(tk.Tk):
    def __init__(self):
        ...
        self.edit_button = tk.Button(self, text="Edit Selected Book", command=self.edit_book)
        self.delete_button = tk.Button(self, text="Delete Selected Book", command=self.delete_book)
    ...
    def edit_book(self):
        selected_title = self.book_list.get(tk.ACTIVE)
        ...
        self.books[selected_title] = {'pages': new_pages, 'time_to_read_10_pages': new_time_to_read_10_pages}
    ...
    def delete_book(self):
        ...
        if not selected_title:
            messagebox.showinfo("Error", "No book selected.")
            return
        del self.books[selected_title]
        self.book_list.delete(tk.ACTIVE)
